 ...
 */
static char     font[] = "SauceCodePro Nerd Font:pixelsize=11:antialias=true:autohint=true";
...
static unsigned int defaultcs = 5; //14
static unsigned int defaultrcs = 15; //15
...
static MouseShortcut mshortcuts[] = {
	/* button               mask            string */
	{ Button4,              XK_NO_MOD,      "\033[A" },
	{ Button5,              XK_NO_MOD,      "\033[B" },
};
